...
const { createQuiz, getQuiz, updateQuiz, deleteQuiz, submitQuiz, getLectureQuiz } = require('../controllers/quizController')
...
// Quiz CRUD
router.get('/lectures/:lectureId/quiz', protect, getLectureQuiz)
